...
class MeetupConnector:
    ...
    def fetch(self, groups: list[Group], cached: bool) -> None:
        ...
        if cached:
            ...
            self.fetch_to_cache(meetup_groups)

        self.generate_events(meetup_groups)

    def fetch_to_cache(self, meetup_groups: list[Group]):
    ...
    def generate_events(self, meetup_groups: list[Group]) -> None:
